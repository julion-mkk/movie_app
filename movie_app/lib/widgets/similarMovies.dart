...
import 'package:movie_app/bloc/getSimilarMoviesBloc.dart';
...
class SimilarMovies extends StatefulWidget {
    final int movieId;
    SimilarMovies({Key key,@required this.movieId}): super(key: key);
    _SimilarMoviesState createState()=> _SimilarMoviesState(this.movieId);
}
...
class _SimilarMoviesState extends State<SimilarMovies> {
    ...
    void initState() {
        super.initState();
        getSimilarMoviesBloc..getSimilarMovies(movieId);
        ...
        return Column(
            ...
            children: <Widget>[
                ...
                StreamBuilder<MovieResponse>(
                    stream: getSimilarMoviesBloc.subject.stream,
